...
const SideBar:FC = () => {
  return (
    <div className="flex flex-col sticky top-0  h-screen p-5 space-y-4 bg-gray-800 w-60">
      <h1 className="font-bold text-white text-3xl">CODEYOGI</h1>

      <NavLink to="/quiz">
        <div className="flex p-2 hover:bg-gray-700 hover:text-white hover:rounded-md text-gray-300 items-center space-x-2">
          <svg
            stroke="currentColor"
            fill="currentColor"
            stroke-width="0"
